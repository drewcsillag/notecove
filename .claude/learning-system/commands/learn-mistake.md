...
4. **Record to MISTAKES.md**: Append to shared MISTAKES.md in the standard format
...
1. Append the new entry to shared `~/.claude/shared-learning/__PROJECT_ID__/MISTAKES.md`
2. Check shared `~/.claude/shared-learning/__PROJECT_ID__/pending-lessons.jsonl` for related unresolved failures
3. Mark any resolved failures as "learned" in the pending file
4. Confirm what was recorded

Note: Shared state is in `~/.claude/shared-learning/__PROJECT_ID__/` - accessible from all worktrees.
