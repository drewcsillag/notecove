...
# Set via CLAUDE_LEARNING_PROJECT env var or defaults to value set by installer
# The installer replaces __PROJECT_ID_PLACEHOLDER__ with the actual project ID
PROJECT_ID="${CLAUDE_LEARNING_PROJECT:-__PROJECT_ID_PLACEHOLDER__}"
