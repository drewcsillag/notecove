...
- 4.1bis.1 Robust Cross-SD Note Moves 🟡 (97% Complete - implementation and unit tests done, integration tests pending - [Plan](./PLAN-PHASE-4.1bis.1.md) | [Architecture](./docs/architecture/cross-sd-move-state-machine.md))
